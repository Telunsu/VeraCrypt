...
enum
{
	...
	// Start with DCUBE means added by datacube
	ERR_DCUBE_NO_ENOUGH_SPACE			    = 1001,
	ERR_DCUBE_NEW_VOLUME_SIZE_TOO_SMALL     = 1002,
	ERR_DCUBE_NEW_VOLUME_SIZE_TOO_LARGE		= 1003
};
